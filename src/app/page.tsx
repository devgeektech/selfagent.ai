...
import IntelligentIcon from "./icons/IntelligentIcon";
    ...
    <div className="homePage">
          ...
          <div className="row align-items-center">
            <div className="col-md-12">
              <div className="banner_text text-center">
               ...
               <p data-aos="fade-up" data-aos-duration="500" className="banner-txt-sml">
                  {" "}
                  Boost engagement significantly by offering an interactive,
                  voice-driven browsing experience with SiteAgent{" "}
                </p>
                <div className="d-flex mt-3 justify-content-center mob-banner">
                  <div className="mob-banner-btn" data-aos="fade-right" data-aos-duration="500">
                    <button className="btnprimary chatbotBtn">
                      Build your AI Agent <ArrowIcon />
                    </button>
                    <p className="text-start mb-0">No credit card required</p>
                  </div>
                  <button className="btndefault chatbotBtn" data-aos="fade-left" data-aos-duration="500">
                    <PlayIcon />
                    Watch Video
                  </button>
                </div>
            ...
            <div className="col-md-12">
              <div className="videoWrapper" data-aos="zoom-in-up" data-aos-duration="1500" data-aos-easing="ease-out-back" data-aos-delay="0">
      ...
      <section className="logosWrapper">
        <div className="container">
            ...
            <h3 className="text-center" data-aos="fade-down" data-aos-duration="500">
              See our <span>News Coverage</span>
            </h3>
        
          <div className="row">
            <div className="col-sm-12" data-aos="zoom-in"  data-aos-duration="500">
      ...
      <section className="affiliate_section">
        <div className="container">
          <div className="affiliate_section_inner">
            <div className="row">
              <div className="col-sm-12">
                ...
                <div className="affiliate_content">
                    ...
                    <h2 className="text-center" data-aos="fade-up"  data-aos-duration="700">
                      ...
                      <span>20% commission</span> on payments for all customers
                      you refer
                    </h2>
      ...
      <section className="tabs_section">
        <div className="tabs_section_upper">
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                <div className="content_width">
               
                    <h3 className="text-center" data-aos="fade-right" data-aos-duration="500">
                      How it <span>Works</span>
                    </h3>
                 
                 
                    <p data-aos="fade-left" data-aos-duration="500">
                      SiteAgent is a leap forward in digital customer
                      engagement, combining the latest AI technology with the
                      nuanced touch of human-like conversation. Our platform is
                      designed to seamlessly integrate with your website,
                      providing your customers with an intelligent, responsive
                      service agent capable of understanding and fulfilling
              ...
              <div className="col-sm-12">
                <div className="tab_wrapper" >
                    <Tabs
                      ...
                      className="justify-content-center" data-aos="zoom-in" data-aos-duration="500"
                    >
        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-12 ">
              ...
              <p className="noCode" data-aos="fade-left" data-aos-duration="500">
          ...
          <div className="row">
            <div className="col-md-4">
                ...
                <div className="benefit_block" data-aos="fade-up" data-aos-duration="500">
                  <div className="benefit_block_text">
                    <h3>Increased <span>Engagement</span></h3>
                    <p>
            ...
            <div className="col-md-4">
                ...
                <div className="benefit_block" data-aos="fade-up" data-aos-duration="500">
                  <div className="benefit_block_text">
                    <h3><span>Higher Conversion</span> Rates</h3>
                    <p>
            ...
            <div className="col-md-4">
                ...
                <div className="benefit_block" data-aos="fade-up" data-aos-duration="500">
                  <div className="benefit_block_text">
                    <h3>Enhanced <span>Customer Satisfaction</span></h3>
                    <p>
            ...
            <div className="col-md-4">
              ...
              <div className="benefit_block" data-aos="fade-up" data-aos-duration="500">
                <div className="benefit_block_text">
                  <h3>Operational <span>Efficiency</span></h3>
                  <p>
            ...
            <div className="col-md-4">
                ...
                <div className="benefit_block" data-aos="fade-up" data-aos-duration="500">
                  <div className="benefit_block_text">
                    <h3><span>Trustworthy</span>, accurate answers</h3>
                    <p>
                      Quick, accurate, and personalized support means happier
                      customers and stronger loyalty.
                    </p>
      ...
      <section className="pwerful_feature_section">
        <div className="container">
          <div className="pwerful_feature_section_inner">
            <div className="row">
              <div className="col-md-3">
                <div className="leftSide">
            
                  <h2 className="gradient_color" data-aos="fade-right" data-aos-duration="500">
              ...
              <div className="col-md-9">
                <div className="rightSide">
                  ...
                  <div className="blockFull" data-aos="fade-left" data-aos-duration="500">
                    <div className="pwerful_block">
                      ...
                      <p>
                        Our AI doesn't sleep. SiteAgent is on hand
                        round-the-clock to ensure your customers receive instant
                        assistance, anytime they need it.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="blockFull" data-aos="fade-left" data-aos-duration="500">
                    <div className="pwerful_block">
                      ...
                      <p>
                        By learning about your business and its offerings,
                        SiteAgent delivers tailored conversations that resonate
                        with your customers, driving satisfaction and loyalty.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="blockFull" data-aos="fade-left" data-aos-duration="500">
                    <div className="pwerful_block">
                      ...
                      <p>
                        Beyond text, SiteAgent offers live voice interactions,
                        making customer service more accessible and personal
                        than ever before. It's like having a human agent, but
                  ...
                  <div className="blockFull" data-aos="fade-left" data-aos-duration="500">
                    <div className="pwerful_block">
                      ...
                      <p>
                        ...
                        customers to products or services they seek, boosting
                        sales and enhancing the shopping experience.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="blockFull" data-aos="fade-left" data-aos-duration="500">
                    <div className="pwerful_block">
                      ...
                      <p>
                        ...
                        infrastructure, SiteAgent starts transforming your
                        customer service experience with minimal effort from
                        your side.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="blockFull" data-aos="fade-left" data-aos-duration="500">
                    <div className="pwerful_block">
                      ...
                      <h4>80+ Languages</h4>
                      <p>
                        Reach your customers in their native language even if
                        your data is in a different language.
                      </p>
                    </div>
                  </div>
      ...
      <section className="safetyWrapper">
        <div className="container">
          <div className="safetyWrapperInner">
            <div className="row">
              <div className="col-md-3">
           
                <div className="leftSide">
                  <h2 className="gradient_color" data-aos="fade-up" data-aos-duration="600">
                    Safety and <span>Security</span>
                  </h2>
              ...
              <div className="col-md-9">
                ...
                <div className="rightSide">
                  ...
                  <div className="blockFull" data-aos="fade-up" data-aos-duration="600">
                    <div className="pwerful_block">
                      <div className="feature_icon">
                        <SecureIcon />
                      </div>
        ...
        <div className="container">
          <div className="col-sm-12">
            ...
            <div className="video_wrapper">
              <Image data-aos="zoom-in" data-aos-duration="800"
                className="w-100 h-auto"
                src={videoImage}
                alt="videoImage"
              />
      ...
      <section className="useCases_section">
        <div className="container">
          <div className="useCases_section_inner">
            <div className="row">
              <div className="col-sm-12">
          
                <h2 className="text-center" data-aos="fade-right" data-aos-duration="500">
                  <span>Usecases</span>
                </h2>
              
              
                <p className="text-center" data-aos="fade-left" data-aos-duration="500">
            ...
            <div className="text_image_block">
              <div className="row">
                <div className="col-md-6" data-aos="fade-down" data-aos-duration="500">
                ...
                <div className="col-md-6" data-aos="fade-down" data-aos-duration="500">
                  ...
                  <div className="support_text">
                    ...
                    <p>
                      ...
                      converting conversations into valuable leads for
                      sustainable growth and increased success.
                    </p>
                  </div>
            ...
            <div className="text_image_block">
              <div className="row">
                <div className="col-md-6" data-aos="fade-down" data-aos-duration="500">
                  ...
                  <div className="support_text">
                    <h3>
                      AI Personas to<span> Engage Your Users</span>
                    </h3>
                    <p>
                      Create AI personas about any topic and have them engage
                      with your users and provide them with a personalized
                      experience.
                    </p>
                  </div>
                  <div className="support_img">
                ...
                <div className="col-md-6" data-aos="fade-down" data-aos-duration="500">
                  ...
                  <div className="support_text">
                    <h3>
                      <span>Multi-platform</span> Chatbots
                    </h3>
                    <p>
      ...
      <section className="website__gradient_section">
        <div className="container">
          <div className="website__gradient_section_inner">
            <div className="row">
              <div className="col-sm-12">
            
                <h5 data-aos="fade-down" data-aos-duration="500">
                  Your website becomes more than just a place to get information
                  or shop. It becomes a dynamic, engaging, and smart platform
                  that understands and interacts with your customers in a whole
                  new way. Upgrade your customer service, boost your sales, and
